[![Run App ErinCase](https://github.com/ecase6/GithubActions/actions/workflows/run-app.yaml/badge.svg)](https://github.com/ecase6/GithubActions/actions/workflows/run-app.yaml)
